...
| Simple: inventory availability | inventory_availability_pct | 0.013 | inventory_availability_pct | Useful as a single-driver check. |
| Simple: customer rating | customer_rating | 0.001 | None at 5% | Useful as a single-driver check. |
...
- The p-values are approximate because the analysis uses a normal approximation.
